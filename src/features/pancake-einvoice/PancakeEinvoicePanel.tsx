...
import { DailyStockScheduleSection } from './DailyStockScheduleSection';
import { SalesSummaryScheduleSection } from './SalesSummaryScheduleSection';
...
export function PancakeEinvoicePanel({
  ...
  return (
    <>
      ...
      <DailyStockScheduleSection shopKey={shopKey} />
      {shopKey === 'meit' && <SalesSummaryScheduleSection />}
    </>
  );
}
